    ...
    <div class="flex flex-col md:flex-row items-center pb-0 md:pb-24">
      <div class="hidden md:flex relative w-2/3 justify-center">
        <div class="absolute left-0 z-10">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/d/d6/Better_logo.svg"
            class="w-2/3 xl:w-1/2 -mt-6"
            data-sal="slide-right" data-sal-delay="200"
          />
        </div>
        <div class="absolute flex w-full justify-end z-10">
          <img
          src="https://upload.wikimedia.org/wikipedia/commons/d/d6/Better_logo.svg"
            class="w-2/3 xl:w-1/2 h-58 object-cover mt-60 mr-16"
            data-sal="slide-left" data-sal-delay="500"
          />
        </div>
        <div class="bg-green-100 opacity-5 rounded-3xl w-3/5 h-96"></div>
      </div>
      <div class="flex-1" data-sal="slide-up" data-sal-delay="700">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between gap-6">
      <div class="w-full md:w-1/2" data-sal="slide-up" data-sal-delay="300">
        <p class="text-lg text-green-600 font-medium">
          ...
          <!-- {{ ("productSection.variantTitle") }} -->
        </p>
        <p class="text-3xl font-black">
          {{ $t("productSection.variant") }}
          <!-- {{ ("productSection.variant") }} -->
        </p>
        <p class="text-lg font-medium leading-relaxed pt-4">
          {{ $t("productSection.variantDescription") }}
          <!-- {{ ("productSection.variantDescription") }} -->
        </p>
      </div>
    ...
    >
      <div class="w-full md:w-1/3">
        <p class="text-4xl text-center md:text-left text-gray-100 font-bold">
          ...
          <!-- {{ ("productSection.getProductTitle") }} -->
        </p>
      </div>
